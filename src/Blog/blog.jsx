...
const Blog = () => {
  return (
    ...
    <div className='blog'>
      <Header></Header>
      {/* <header></header> */}
      <h1 data-text="How to build a website" className='blogheader'><span>How to build a website</span></h1>
      <blockquote>
      <p className='blogp1'>
        No matter what type of site you want to make, your website should represent you or your business in the best
        light possible. This is often easier said than done; it’s not uncommon to get burn out when building a website
        from scratch or using a website maker.
      </p>
      </blockquote>

      <p className='blogp1'>
        Fortunately, this guide will show you how to build a website from scratch while maintaining your sanity. Keep
        reading for expert tips on getting started, or check out our website launch checklist for additional steps on
        getting your site publish-ready.
      </p>

      <h2 style={{ marginTop:'30px', marginLeft:'50px'}}>How to Make a Website from Scratch</h2>

      <ol style={{ marginTop:'30px', marginLeft:'50px'}}>
        <li>
